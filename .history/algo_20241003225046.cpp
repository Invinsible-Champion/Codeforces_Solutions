...
//test case 3
/*
maze[0][1].walls = 1;      // North wall at (0,1)
maze[0][2].walls = 3;      // North and East walls at (0,2)
maze[0][3].walls = 2;      // East wall at (0,3)
maze[0][4].walls = 1;      // North wall at (0,4)
maze[0][6].walls = 1;      // North wall at (0,6)

maze[1][0].walls = 8;      // West wall at (1,0)
maze[1][1].walls = 2;      // East wall at (1,1)
maze[1][2].walls = 1;      // North wall at (1,2)
maze[1][3].walls = 4;      // South wall at (1,3)
maze[1][4].walls = 6;      // North and East walls at (1,4)
maze[1][5].walls = 8;      // West wall at (1,5)

maze[2][0].walls = 1;      // North wall at (2,0)
maze[2][1].walls = 4;      // South wall at (2,1)
maze[2][2].walls = 1;      // North wall at (2,2)
maze[2][5].walls = 1;      // North wall at (2,5)

maze[3][0].walls = 4;      // South wall at (3,0)
maze[3][1].walls = 4;      // South wall at (3,1)
maze[3][3].walls = 2;      // East wall at (3,3)
*/
    fl(maze); 
